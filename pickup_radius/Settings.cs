...
public class Settings {
    ...
    public static ConfigEntry<float> m_pickup_radius;
    ...
    public void load(DDPlugin plugin) {
        ...
        m_pickup_radius = this.m_plugin.Config.Bind<float>("General", "Pickup Radius", 2.5f, "Radius (in meters/yards?) around player in which objects will be drawn to the player (float, default 2.5 [game default]).");
    }
}